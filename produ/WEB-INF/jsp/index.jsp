					...
					<ul class="nav navbar-top-links">
						...
						<li id="dropdown-user" class="dropdown">
							<a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
								<%-- 								<div class="index-username hidden-xs">${userName}</div> --%>
								...
								<div id="mainnav-profile" class="mainnav-profile">
									<div class="profile-wrap text-center">
										<h4 class="text-lg text-overflow mar-no">
											<p class="mnp-name">${ownerName}</p>
										</h4>
										<div class="pad-btm">
											<img class="img-circle img-md" src="${ empty logo  ? 'images/no_photo.jpg' : image }" alt="usuario">
										</div>
								...
								<ul id="mainnav-menu" class="list-group">
									...
									<li>
										...
										<ul class="collapse">
											...
											<li id="movieLanguages" >
												<a href="#app/movieLanguages">
													Movie language
												</a>
											</li>
											<li id="languageRoles" >
												<a href="#app/languageRoles">
													LanguageRole
												</a>
											</li>
											<li id="countrys" >
