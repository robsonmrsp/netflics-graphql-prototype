/* Role´s Search Page generated by JSetup v0.95 :  at 1 de fev de 2023 21:03:52  */
...
const Page = () => {
  const service = new HttpRequest("/rs/crud/roles");
      ...
      >
        <Stack direction="row" spacing={2}>
          ...
          <Button
            color="secondary"
            variant="contained"
            onClick={() => Router.push('/role/new').catch(console.error)}
          >
            Novo
          </Button>
        </Stack>
