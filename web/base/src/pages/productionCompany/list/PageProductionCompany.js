...
const toFilterProductionCompany = (values) => {
  return { 
    ...values,
  }
}
...
const columns = [
  ...
  },	
  {
    ...
    renderCell: (cellValues) => <ActionCell
      ...
      onEdit={(row) => {
        Router
          .push('/productionCompany/edit/' + row.id)
          .catch(console.error);
      }}
      onDelete={(row) => {
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterProductionCompany(values));
  }
  ...
  return <>
    <Head>
      <title>
        Listagem de ProductionCompanys
      </title>
    </Head>
    <Card>
      <CardHeader
      ...
      >
        <Stack direction="row" spacing={2}>
          ...
          <Button
            color="secondary"
            variant="contained"
            onClick={() => Router.push('/productionCompany/new').catch(console.error)}
          >
            Novo
          </Button>
        </Stack>
