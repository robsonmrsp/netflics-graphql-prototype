...
const toFilterMovieLanguages = (values) => {
  return { 
    ...values,
  }
}
...
const columns = [
  { field: 'id', headerName: 'ID', width: 90 },
  {
    ...
    renderCell: (cellValues) => <ActionCell
      ...
      onEdit={(row) => {
        Router
          .push('/movieLanguages/edit/' + row.id)
          .catch(console.error);
      }}
      onDelete={(row) => {
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterMovieLanguages(values));
  }
      ...
      >
        <Stack direction="row" spacing={2}>
          ...
          <Button
            color="secondary"
            variant="contained"
            onClick={() => Router.push('/movieLanguages/new').catch(console.error)}
          >
            Novo
          </Button>
        </Stack>
