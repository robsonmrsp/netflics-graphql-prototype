/* MovieLanguage´s Search Page generated by JSetup v0.95 :  at 1 de fev de 2023 21:03:52  */
...
const toFilterMovieLanguage = (values) => {
  return { 
    ...values,
  }
}
...
const columns = [
  { field: 'id', headerName: 'ID', width: 90 },
  {
    ...
    renderCell: (cellValues) => <ActionCell
      ...
      onEdit={(row) => {
        Router
          .push('/movieLanguage/edit/' + row.id)
          .catch(console.error);
      }}
      onDelete={(row) => {
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterMovieLanguage(values));
  }
      ...
      >
        <Stack direction="row" spacing={2}>
          ...
          <Button
            color="secondary"
            variant="contained"
            onClick={() => Router.push('/movieLanguage/new').catch(console.error)}
          >
            Novo
          </Button>
        </Stack>
