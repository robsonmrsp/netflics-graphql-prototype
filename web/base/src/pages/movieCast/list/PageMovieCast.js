/* MovieCast´s Search Page generated by JSetup v0.95 :  at 1 de fev de 2023 21:03:52  */
...
const toFilterMovieCast = (values) => {
  return { 
    ...values,
  }
}
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterMovieCast(values));
  }
      ...
      >
        <Stack direction="row" spacing={2}>
          ...
          <Button
            color="secondary"
            variant="contained"
            onClick={() => Router.push('/movieCast/new').catch(console.error)}
          >
            Novo
          </Button>
        </Stack>
